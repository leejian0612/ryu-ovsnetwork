...
from quantum.extensions.ovsnetwork_rpc_agent import OVSNetworkAgentRpcCallbackApiMixin
...
class OVSQuantumOFPRyuAgent(sg_rpc.SecurityGroupAgentRpcCallbackMixin,OVSNetworkAgentRpcCallbackApiMixin):
    ...
    def _setup_rpc(self):
        ...
        consumers = [[topics.PORT, topics.UPDATE],
                     ...
                     [OVSNETWORK,topics.CREATE],
                     [OVSNETWORK,topics.UPDATE],
                     [OVSNETWORK,topics.DELETE]]
