...
class API(base.Base):
    ...
    def allocate_for_instance(self, context, instance, **kwargs):
        ...
        for network in nets:
            ...
            LOG.debug(_("network information is:%s"),network)               
            if network.get('is_an_ovs',False):
                pass
            else:                            
    ...
    def _build_network_info_model(self, context, instance, networks=None):
        ...
        for port in ports:            
            ...
            for net in networks:
                #LOG.debug(_("lee net info is %s"),net)
                if port['network_id'] == net['id']:
                    is_an_ovs = net.get('is_an_ovs',None)
            ...
            #elif vif_type == 'ovsnetwork':
            #    bridge = "ovs" + port['network_id']
            
            if is_an_ovs:
               bridge = "ovs" + port['network_id'] 
               print 'lee bridge is',bridge             
